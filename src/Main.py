...
player_indi = Label(window, font=("arial", 40, "bold"), text="PLAYER", bg="orange", fg="blue")
computer_indi = Label(window, font=("arial", 40, "bold"), text="COMPUTER", bg="orange", fg="blue")
...
Button(window, width=16, height=3, text="Rock", font=("arial", 20, "bold"), bg="yellow", fg="red",
       command=lambda: choice_update("rock")).grid(row=2, column=1)
Button(window, width=16, height=3, text="Paper", font=("arial", 20, "bold"), bg="yellow", fg="red",
       command=lambda: choice_update("paper")).grid(row=2, column=2)
Button(window, width=16, height=3, text="Scissor", font=("arial", 20, "bold"), bg="yellow", fg="red",
